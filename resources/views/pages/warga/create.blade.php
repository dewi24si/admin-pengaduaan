...
@section('content')
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white">
            <h5 class="mb-0"><i class="bi bi-person-plus me-2"></i>Tambah Data Warga</h5>
        </div>
        <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="no_ktp" class="form-control @error('no_ktp') is-invalid @enderror"
                            value="{{ old('no_ktp') }}" required maxlength="16" placeholder="Masukkan No KTP">
                        @error('no_ktp')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="agama" class="form-control @error('agama') is-invalid @enderror"
                            value="{{ old('agama') }}" required placeholder="Masukkan agama">
                        @error('agama')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
